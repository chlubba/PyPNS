...
diametersUnmyel = np.arange(0.2, 4, 0.4)# (0.120, 0.17,  0.21,  0.26,  0.32,  0.37,  0.41,  0.47,  0.51,  0.56,  0.62,  0.67,  0.72,  0.77,  0.84,  0.92,  0.97,  1.02,  1.07,  1.12,  1.17,  1.22,  1.27,  1.32, 1.36, 1.41, 1.48, 1.52)# [0.12, 1.52] # np.arange(0.2, 2, 0.3)
...
diametersMyel = diametersUnmyel # np.arange(0.4, 1.1, 0.02)
...
if calculationFlag:
    ...
    for i in [0,1]:
        ...
        for diameterInd, diameter in enumerate(diameters):
            ...
            LFPMech.append(PyPN.Extracellular.interpolator(bundle.bundleCoords))
        ...
        if i == 0:
            ...
            saveDict['amplitudes'] = amplitudes
...
pickle.dump(saveDict, open(os.path.join('SFAPs', 'SFAPsPowleyMyelAsRecordingsIdealizedCuffHigherDiams.dict'), "wb"))
