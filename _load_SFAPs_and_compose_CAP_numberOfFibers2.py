...
jitterDists = [0] # np.arange(0,electrodeDistance*0.1,electrodeDistance*0.02) # np.arange(0,electrodeDistance*0.1,electrodeDistance*0.01)
for jitterInd, jitterDist in enumerate(jitterDists):
    ...
    for runInd in range(1):
        ...
        amplitudeArray = []
        meanAmpArray = []
        numMyels = [100, 1000, 10000, 100000]
        # numMyels = [100, 1000]

        for numMyelInd, numMyel in enumerate(numMyels):
    ...
    axarr[0].errorbar(numMyels, amplitudeMeans, yerr=amplitudeStd, label='distance variability ' + str(jitterDist/electrodeDistance) + ' %') # , label=str(numMyel) + ' fibers')
    axarr[1].errorbar(numMyels, amplitudeMeanMeans, yerr=amplitudeMeanStd, label='distance variability ' + str(jitterDist/electrodeDistance) + ' %') # , label=str(numMyel) + ' fibers')
