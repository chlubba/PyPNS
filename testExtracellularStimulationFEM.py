...
myelinatedDiam =  2 # {'distName' : 'normal', 'params' : (1.0, 0.7)} # (2.0, 0.7)
...
stimulationElectrodeParameters = {'bundleGuide': bundleGuide,
                          'radius': 200,
                          'positionAlongBundle': 200,
                          'numberOfPoles': 2,
                          'poleDistance': 1000,
                          }
...
if calculationFlag:
    ...
    if electricalStimulusOn:
        ...
        bundle.add_excitation_mechanism(PyPN.StimFieldQuasistatic(**FEMStimParameters))
