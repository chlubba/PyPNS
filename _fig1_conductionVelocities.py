...
diameters = np.flipud(np.arange(.2, 5., .5))
temperatures = np.arange(5, 46, 5)

saveDict = {'axonType': 'myelinated',
            'diameters': diameters,
...
pickle.dump(saveDict, open(os.path.join('/media/carl/4ECC-1C44/PyPN/condVel', 'conductionVelocitiesMyelinated.dict'), "wb"))
