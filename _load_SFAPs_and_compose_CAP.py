...
saveDict = pickle.load(open(os.path.join('/media/carl/4ECC-1C44/PyPN/SFAPs', 'SFAPsPowley.dict'), "rb" )) # thinnerMyelDiam
...
jitterAmp = 5 #ms
jitterDist = 0 # 0.1*electrodeDistance
numMyel = 1000
numUnmyel = 10000
poles = 2
poleDistance = 1 # mm
