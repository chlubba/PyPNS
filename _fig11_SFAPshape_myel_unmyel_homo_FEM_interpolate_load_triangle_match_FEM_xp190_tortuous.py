...
if calculationFlag:
    ...
    # f.suptitle("Random direction component 0.6", fontsize=14)
    plt.text(.05, .95, 'rdc 0.6', transform=f.transFigure, horizontalalignment='center', fontsize=14)
    plt.text(.25, .95, '$\phi_{static}$ = f(|z$_{elec}$ - z$_{axon}$|, i$_{static}$)', transform=f.transFigure, horizontalalignment='center', fontsize=18)
    # plt.text(.6, .95, '$\phi$(t)', transform=f.transFigure, horizontalalignment='center',fontsize=14)
    # plt.text(.9, .95, '$\phi$(t)', transform=f.transFigure, horizontalalignment='center', fontsize=14)
    # plt.show()

    bundleLocations = ['/media/carl/4ECC-1C44/PyPN/dt=0.0025 tStop=70 pMyel=0 pUnmyel=1 L=40000 nAxons=1/bundle00008',
                       '/media/carl/4ECC-1C44/PyPN/dt=0.0025 tStop=70 pMyel=1 pUnmyel=0 L=40000 nAxons=1/bundle00001']
