...
bundleParameters = {    'radiusBundle': 150, #150, #um Radius of the bundle (typically 0.5-1.5mm)
...
if calculationFlag:
    ...
    # bundle = PyPN.open_bundle_from_location('/media/carl/4ECC-1C44/PyPN/dt=0.005 tStop=50 p_A=0.1 p_C=0.9 L=10000 nAxons=50 bipolarRecording/bundle00000')
