    ...
    for i in [0]:
        ...
        for recMechIndex in [1]:
            ...
            for diameterInd, diameter in enumerate(diameters):
                ...
                LFPMech.append(PyPN.Extracellular.precomputedFEM_6D(bundle.bundleCoords, interpolationOrder=2))
                ...
                # LFPMech.append(PyPN.Extracellular.interpolationExtracellular(bundle.bundleCoords, zInterpolator=()))
                ...
                relPositions = [0.5] # np.arange(0, 0.5, 0.05)
