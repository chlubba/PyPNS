...
amplitudes = np.logspace(1.5, 2.5, 15) * 3 # np.logspace(1.5, 3, 12) * 3 # [150, 450, 750, 1050, 1450, 1750, 2050, 2350, 2650] # [150, 300, 450, 600, 750, 900, 1050, 1300, 1450] # np.logspace(2,4,10)
runs = 1
...
if not rank == 0:
    ...
    pickle.dump(saveDict, open(os.path.join('activationExtracellular', 'myelinated1RunsRDC0Log300_1000Disp0Radius190.dict'), "wb"))
